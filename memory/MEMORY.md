...
- [MacBook M5 Pro](user_macbook_m5pro.md) — MBP M5 Pro: primary workstation, Claude/CC primary tools, Hermes uninstalled (on Mac Mini now), Ollama no active use case
- [Mac Mini M4](user_mac_mini_m4.md) — Mac Mini M4 16GB active: macOS Tahoe 26.5, IP 192.168.68.85, HAOS/Ollama/Docker/Hermes+Telegram running
